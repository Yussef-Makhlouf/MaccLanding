        ...
        return (
          <div className="relative flex-shrink-0 z-50 " ref={dropdownRef}>
            ...
            <button
              ...
              className="flex items-center justify-center gap-1 py-2 px-2 bg-transparent  transition-all duration-200 h-full group border-none"
            >
              {/* Flag or Icon */}
              {value ? (
                ...
                <div className="p-3 border-b border-gray-100 bg-gray-50/50">
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-3 py-2 ${isRTL ? 'pl-9 pr-3' : 'pr-9 pl-3'} text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white ${
